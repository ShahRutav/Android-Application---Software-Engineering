...
public class BlogDetailsAdminActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_blog_details_admin );
    ...
    private void getBlogDetails(String BlogID) {
        DatabaseReference productsRef = FirebaseDatabase.getInstance().getReference().child("Blog Admin").child(LoginActivity.currentuser.getEmail());
