...
public class MyBlogFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        RecyclerViewHome = (RecyclerView)view.findViewById(R.id.recycler_menu_my_blog);
        BlogRef = FirebaseDatabase.getInstance().getReference().child("Blog Admin").child(LoginActivity.currentuser.getEmail());
                    ...
                    protected void onBindViewHolder(@NonNull BlogViewHolder holder, int position, @NonNull final Blog model)
                    {
                        ...
                        holder.itemView.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View view)
                            {
                                ...
                                Intent intent = new Intent(getActivity(), BlogDetailsAdminActivity.class);
